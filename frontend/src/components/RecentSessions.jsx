    ...
    <div className="card bg-base-100 border-2 border-accent/20 hover:border-accent/30 mt-8">
      <div className="card-body">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-black">Các Session trước đây của bạn</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading ? (
                ...
                <div className="card-body p-5">
                  ...
                  <div className="space-y-2 text-sm opacity-80 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {session.participant ? "2" : "1"} người tham gia
                      </span>
                    </div>
                  </div>

                  <div className="flex items-center justify-between pt-3 border-t border-base-300">
                    <span className="text-xs font-semibold opacity-80 uppercase">Đã hoàn thành</span>
            ...
            <div className="col-span-full text-center py-16">
              ...
              <p className="text-lg font-semibold opacity-70 mb-1">Chưa có Session nào</p>
              <p className="text-sm opacity-50">Bắt đầu hành trình lập trình của bạn ngay hôm nay!</p>
            </div>
          )}
        </div>
      </div>
